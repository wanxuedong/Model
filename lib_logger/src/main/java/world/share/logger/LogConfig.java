...
import world.share.baseutils.ApkUtil;
...
public class LogConfig {
     ...
     * 普通日志写在本地文件夹的名称
     **/
    public static final String NORMAL_LOG_NAME = Environment.getExternalStorageDirectory().getPath() + File
            .separator + ApkUtil.getPackageName() + File.separator + "log" + File.separator;
    /**
     * 崩溃日志写在本地文件夹的名称
     **/
