package world.share.video.utils;
...
public class FileUtil {
     ...
     * 默认生成的文件父文件夹
     */
    private static final String FILES_NAME = "AFeel";
    ...
    public static String getPath(String presentPath, String name, String suffix) {
        ...
        File presentFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + presentPath + File.separator);
        // 判断父级文件是否已经存在，不存在则创建
